            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" >
                            ...
                            <div class="modal-footer d-flex justify-content-between" style={{color:"red"}}>
                                ...
                                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal1" data-bs-dismiss="modal"><button id="bt-cl" type="button"  data-bs-dismiss="modal" style={{left:"380px",top:"540px",position:"absolute",opacity:"0"}} onClick={block3}>upload</button>Upload</button>
                            </div>
                            </div>
                        </div>
            </div>
                ...
                <div class="modal-dialog  modal-lg" >
                    <div class="modal-content" style={{borderRadius:"20px"}}>                        
                        <div class="modal-body d-flex flex-column align-items-center">
                            <h3 class="text-center" style={{color:"#0497E1"}}><b> Berhasil upload portofolio</b></h3>
