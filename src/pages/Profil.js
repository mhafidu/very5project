                ...
                <div class="modal-dialog  modal-lg" >
                    <div class="modal-content" style={{borderRadius:"20px"}}>                        
                        <div class="modal-body d-flex flex-column align-items-center">
                            <h3 class="text-center" style={{color:"#0497E1"}}><b> Berhasil mengedit  profil!</b></h3>
                            ...
                            <button type="button" class="btn btn-primary mt-4" data-bs-dismiss="modal">Mengerti</button>
                        </div>                    
                    </div>
                </div>
            </div>
